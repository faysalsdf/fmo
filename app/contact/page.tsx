        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">+880 1309 179246</p>
                  <a
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">info@fmosweb.com</p>
                </div>
              </div>
            ...
            <div className="mt-8 p-4 bg-green-50 rounded-lg">
              ...
              <p className="text-green-700 text-sm">
                For fastest response, contact us via WhatsApp. We typically respond within minutes during business
                hours.
              </p>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-lg shadow-lg p-8 text-white">
            <div className="text-center">
              ...
              <p className="text-green-100 text-sm mt-4">Available 24/7 • Usually responds in minutes</p>
            </div>
          </div>
        </div>
      </div>
